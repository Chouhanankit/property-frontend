              ...
              <button
                className={
                  location.pathname === "/register"
                    ...
                    : "bg-blue-50 p-2 w-1/2 "
                }
              >
                Sign Up
              </button>
            </span>
            {/* <h1 className="text-blue-500 font-semibold text-4xl ">Create Account</h1> */}
            <div className="w-full flex-1 mt-8">
              <div className="flex flex-col items-center">
                <button
                  onClick={loginwithgoogle}
                  className="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-blue-200 hover:bg-blue-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline"
                >
